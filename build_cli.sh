...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/${ORG_NAME:-Neofilisoft}/versions/refs/heads/main"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/${ORG_NAME:-Neofilisoft}/nvecode-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/${GH_REPO_PATH:-Neofilisoft/nvecode}/releases"
fi
